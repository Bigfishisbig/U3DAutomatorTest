...
# coding=utf-8
"""
文件名称：SwipeImageTestCase.py
作者：ycy
版本：PPTPro
创建时间：2019/3/22 16:31
修改时间：
软件：PyCharm
"""
...
class SwipeImageTestCase(Action, Operation, SystemDiaglog):
    '''放映态拖动图片'''
    def test_main(self):
        '''放映态拖动图片'''
        ...
        element = self.getElementPath("ItemImageComp")
        self.Click_XY()
