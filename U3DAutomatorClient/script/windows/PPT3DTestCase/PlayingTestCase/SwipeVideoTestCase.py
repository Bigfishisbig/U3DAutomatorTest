...
# coding=utf-8
"""
文件名称：SwipeVideoTestCase.py
作者：ycy
版本：PPTPro
创建时间：2019/3/22 16:47
修改时间：
软件：PyCharm
"""
...
class SwipeVideoTestCase(Action, Operation, SystemDiaglog):
    '''放映态拖动视频'''
    def test_main(self):
        '''放映态拖动视频'''
        ...
        path = SourcePath.File_Video_mp4
        self.OpenVideo(path)
