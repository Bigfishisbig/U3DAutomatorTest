...
# coding=utf-8
"""
文件名称：AudioPlayClickTestCase.py
作者：ycy
版本：PPTPro
创建时间：2019/3/21 19:57
修改时间：
软件：PyCharm
"""
...
class AudioPlayClickTestCase(Action, Operation, SystemDiaglog):
    '''验证音频点击播放'''
    def test_main(self):
        '''验证音频点击播放'''
        self.OperationSetting()
        self.Init3DPPT()
        self.SetTag("验证音频点击播放", time.time())
        ...
        self.WaitForElementText("AudioPlayCurrentTime", "00:15", 30, "音频播放失败")
        time.sleep(2)
