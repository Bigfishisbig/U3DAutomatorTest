...
class TextParaSettingIndentSpaceRow2TestCase(Action, Operation, SystemDiaglog):
    '''段落-行距-1.5倍行距'''
    def test_main(self):
        '''段落-行距-1.5倍行距'''
        # 段落-行距-1.5倍行距
        ...
        time.sleep(1)
        self.OneClick("RowSpace2")
        self.OneClick("BtnParaOK")
        self.s_witForImg(SourcePath.File_Img_Text_Para_Setting_Indent_Space2, 5, "设置1.5倍行距失败")
        self.endScene(tag)
