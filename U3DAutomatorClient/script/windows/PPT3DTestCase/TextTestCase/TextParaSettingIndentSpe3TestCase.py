...
# coding=utf-8
"""
文件名称：TextParaSettingIndentSpe3TestCase.py
作者：ycy
版本：PPTPro_1007 Q6
...
class TextParaSettingIndentSpe3TestCase(Action, Operation, SystemDiaglog):
    '''段落-设置界面打开特殊格式下拉框选中首行缩进并确定'''
    def test_main(self):
        '''段落-设置界面打开特殊格式下拉框选中首行缩进并确定'''
        # 段落-设置界面打开特殊格式下拉框选中首行缩进并确定
        ...
        self.s_witForImg(SourcePath.File_Img_Text_Para_Setting_Indent_Spe, 5, "特殊格式首行缩进失败", 0.4)
        self.endScene(tag)
        # self.OneClick("BtnParaOK")
