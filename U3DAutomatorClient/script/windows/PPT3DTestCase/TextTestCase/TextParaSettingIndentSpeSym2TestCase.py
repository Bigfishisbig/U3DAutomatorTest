...
# coding=utf-8
"""
文件名称：TextParaSettingIndentSpeSym2TestCase.py
作者：ycy
版本：PPTPro_1007 Q6
创建时间：2018/11/26 20:15
修改时间：
软件：PyCharm
"""
...
class TextParaSettingIndentSpeSym2TestCase(Action, Operation, SystemDiaglog):
    '''段落-带编号设置悬挂缩进3cm小于文本之前缩进3cm'''
    def test_main(self):
        '''段落-带编号设置悬挂缩进3cm小于文本之前缩进3cm'''
        # 段落-带编号设置悬挂缩进3cm小于文本之前缩进3cm
        ...
        self.s_witForImg(SourcePath.File_Img_Text_Para_Setting_Indent_Spe6, 5, "悬挂缩进小于文本之前缩进失败")
        self.endScene(tag)