...
class TextParaSettingIndentSpaceRow6TestCase(Action, Operation, SystemDiaglog):
    '''段落-行距-多倍行距'''
    def test_main(self):
        '''段落-行距-多倍行距'''
        # 段落-行距-多倍行距
        ...
        time.sleep(1)
        self.WaitForElementText("InputFieldParaSpace2", "3", 5, "多倍行距默认值异常")

        self.OneClick("BtnParaOK")
        self.s_witForImg(SourcePath.File_Img_Text_Para_Setting_Indent_Space5, 5, "设置多倍行距失败", 0.4)
        self.endScene(tag)
