...
# coding=utf-8
"""
文件名称：TextParaSettingIndentSpeSym3TestCase.py
作者：ycy
版本：PPTPro_1007 Q6
创建时间：2018/11/26 20:21
修改时间：
软件：PyCharm
"""
...
class TextParaSettingIndentSpeSym3TestCase(Action, Operation, SystemDiaglog):
    '''段落-带编号设置悬挂缩进3cm大于文本之前缩进3cm'''
    def test_main(self):
        '''段落-带编号设置悬挂缩进3cm大于文本之前缩进3cm'''
        # 段落-带编号设置悬挂缩进3cm大于文本之前缩进3cm
        ...
        time.sleep(1)
        self.InputStr("4") # 悬挂缩进4cm
        tag = (self.__class__.__doc__ or u"测试") + "_" + self.__class__.__name__  
        self.startScene(tag)
        self.OneClick("BtnParaOK")
        self.s_witForImg(SourcePath.File_Img_Text_Para_Setting_Indent_Spe7, 5, "悬挂缩进大于文本之前缩进失败")
        self.endScene(tag)
