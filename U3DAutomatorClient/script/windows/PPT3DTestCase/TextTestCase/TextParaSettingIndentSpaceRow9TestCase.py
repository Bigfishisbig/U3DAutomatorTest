...
class TextParaSettingIndentSpaceRow9TestCase(Action, Operation, SystemDiaglog):
    '''段落-行距-多倍行距-4-下箭头'''
    def test_main(self):
        '''段落-行距-多倍行距-4-下箭头'''
        # 段落-行距-多倍行距-4-下箭头
        ...
        time.sleep(1)
        self.OneClick("ParaSpaceSub")
        self.WaitForElementText("InputFieldParaSpace2", "2.5", 5, "多倍行距设置值异常")
        self.endScene(tag)
