...
class TextParaSettingIndentSpaceHouTestCase(Action, Operation, SystemDiaglog):
    '''段落-段前设置'''
    def test_main(self):
        '''段落-段前设置'''
        # 段落-段前设置
        ...
        self.s_witForImg(SourcePath.File_Img_Text_Para_Setting_Indent_Para2, 5, "段后距离100失败")
        self.endScene(tag)