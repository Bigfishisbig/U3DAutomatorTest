...
# coding=utf-8
"""
文件名称：TextParaSettingIndentSubTestCase.py
作者：ycy
版本：PPTPro_1007 Q6
创建时间：2018/11/15 11:34
修改时间：
软件：PyCharm
"""
...
class TextParaSettingIndentSubTestCase(Action, Operation, SystemDiaglog):
    '''段落-设置界面-减少缩进'''
    def test_main(self):
        '''段落-设置界面-减少缩进'''
        # 段落-设置界面-减少缩进
        ...
        self.WaitForElementText("InputFieldIndent", "13.9厘", 5, "减少0.1cm缩进失败")
        self.endScene(tag)
