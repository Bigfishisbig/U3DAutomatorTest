...
class TextParaSettingIndentSpaceRow5TestCase(Action, Operation, SystemDiaglog):
    '''段落-行距-固定值行距-2'''
    def test_main(self):
        '''段落-行距-固定值行距-2'''
        # 段落-行距-固定值行距-2
        ...
        self.s_witForImg(SourcePath.File_Img_Text_Para_Setting_Indent_Space4, 5, "固定值设置失败")
        self.endScene(tag)
