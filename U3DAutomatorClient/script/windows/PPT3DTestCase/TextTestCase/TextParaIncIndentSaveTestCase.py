...
# coding=utf-8
"""
文件名称：TextParaIncIndentSaveTestCase.py
作者：ycy
版本：PPTPro_1007 Q6
...
class TextParaIncIndentSaveTestCase(Action, Operation, SystemDiaglog):
    '''段落-缩进光标所在短路并设置保存'''
    def test_main(self):
        '''段落-缩进光标所在短路并设置保存'''
        # 段落-缩进光标所在短路并设置保存
        ...
        # self.s_witForImg(SourcePath.File_Img_Text_Para_Indent_2, 5, "增加缩进失效")
        # self.s_witForImg(SourcePath.File_Img_Text_Para_Indent_Inc, 5, "增加缩进失效")
        time.sleep(1)
